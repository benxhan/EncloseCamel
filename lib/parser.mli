...
(** [load_board filename] reads a character grid from a text file and
    ...
    - Optionally, after all grid rows, a line consisting of [TIP] or [TIPS] (any
      case, ignoring surrounding whitespace on that line only) marks the start
      of a tips section; all subsequent lines become [board.tip]. If omitted or
      blank, [board.tip] is [None].
